...
<%
    ...
    try {
        ...
        if (rs.next()) {
            ...
            String sql = "INSERT INTO hospital_ordrs(uname, uid, umail, company_name, cid, quantity, total_price, time) values (?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            if (row > 0) {
                ...
                response.sendRedirect("View_oxygens1.jsp?Ordered_sent");
            } else {
